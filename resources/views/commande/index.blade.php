...
<body>
    ...
    <div class="collapse d-lg-block" id="sidebarMenu">
        ...
        <div class="flex-grow-1 p-4">
            <div class="container">
                <h1 class="mb-4 custom-text">Liste des Commandes</h1>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $commande->vehicle->marque ?? 'Non assigné' }}</td>
                                <td>{{ $commande->status }}</td>
                                <td>
                                    <a href="{{ route('commande.assign',['id' => $commande->id_commande]) }}" class="btn btn-primary btn-sm">Assigner</a>
                                </td>
                                <td>
                                    <a href="{{ route('commande.show',['id' => $commande->id_commande]) }}" class="btn btn-secondary btn-sm">Détails</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
