...
<!-- resources/views/commande/assign.blade.php -->
<h1>Assigner Livreur et Véhicule à la Commande #{{ $commande->id }}</h1>

<form method="POST" action="{{ route('commande.assign.store', $commande->id) }}">
    @csrf
