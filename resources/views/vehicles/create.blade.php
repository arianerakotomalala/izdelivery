    ...
    <div class="page-flex">
        ...
        <div class="main-wrapper">
            ...
            <main class="main users chart-page" id="skip-target">
                <div class="container">
                    <h1 class="main-title">Ajouter un Véhicule</h1>
                    ...
                    <form action="{{ route('vehicles.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="marque" name="marque" class="form-control" value="{{ old('marque') }}">
                            @error('marque')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="modele" name="modele" class="form-control" value="{{ old('modele') }}">
                            @error('modele')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="numeroPlaque" name="numeroPlaque" class="form-control" value="{{ old('numeroPlaque') }}">
                            @error('numeroPlaque')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>

                        <button type="submit" class="btn btn-success mt-3">Ajouter le Véhicule</button>
                    </form>
                </div>
            </main>
        </div>
